import { createPathComponent, LeafletContextInterface, PathProps } from '@react-leaflet/core';
...
const ReactLeafletTextPath = createPathComponent<LeafletPolyline, ReactLeafletTextPathProps>(
